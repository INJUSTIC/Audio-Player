...
class Controller:
    ...
    def remove_track(self):
        ...
        if selected_index:
            ...
            if self.curr_track == track_to_remove:
                self.isPlaying = False
                self.isPaused = False
                ...
                self.view.select_track(self.view.track_listbox.get(0, tkinter.END).index(self.curr_track))
    ...
    def next_track(self):
        ...
        if current_index:
            self.view.select_track((current_index[0] + 1) % self.view.track_listbox.size())
            self.play_track()
